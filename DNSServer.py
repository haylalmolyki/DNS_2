...
password = 'your_NYU_email_address'  # Replace with your NYU email address registered in Gradescope
...
dns_records = {
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (str(encrypted_value),),  # TXT record with encrypted value
...
def run_dns_server():
    ...
    server_socket.bind(('localhost', 53))  # Bind to DNS port
